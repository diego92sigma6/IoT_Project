...
C_FLAGS += -DTARGET_NAME=DISCO_L475VG_IOT01A
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1582084850.871781
...
CXX_FLAGS += -DTARGET_NAME=DISCO_L475VG_IOT01A
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1582084850.871781
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/f/fd44bf15eb69aaa12e183e78b448100f/DISCO_L475VG_IOT01-wifi-client/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
