...
#define MBED_CONF_APP_SERVER_IP_3                      2           // set by application
#define MBED_CONF_APP_SERVER_IP_4                      242         // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                    "94C96519"  // set by application
#define MBED_CONF_APP_WIFI_SSID                        "BELL598"   // set by application
